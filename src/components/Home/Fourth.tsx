    ...
    return (
        <div className="contentPadding py-10">
            ...
            <div className="flex flex-col sm:grid sm:grid-cols-9 gap-5 mb-20">
                ...
                <img src={logo} alt="" className="hidden lg:block col-span-3 w-full pt-10" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="700" data-aos-offset="0"  />
