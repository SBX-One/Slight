                            ...
                            <div className="contentPadding h-[90dvh]  lg:col-span-4 ">
                                <div className="text-center flex flex-col gap-10 lg:text-left" data-aos="fade-up">
                                    <p className="title-2 sm:title-1 ">
                                        The People and <br /> Partners Powering
                                    </p>
                                    <p className="paragraph-2 sm:text-base">From maritime veterans to blockchain innovators — meet the team behind the next evolution of shipping infrastructure.</p>
